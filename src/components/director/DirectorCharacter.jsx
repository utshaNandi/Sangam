...
import directorImg from '../../assets/characters/director/director-character.png';

export default function DirectorCharacter() {
  ...
  useEffect(() => {
    ...
    const updateEyeTarget = (targetObj) => {
      ...
      const maxMoveDown = 1.5; // Larger downward movement
      ...
      <div className="relative w-full h-full">
        ...
        */}
        <div 
          ...
          style={{ top: '25.3%', left: '55.1%', width: '0px', height: '0px' }}
        >
          <div 
          ...
          >
            <div 
              ref={leftPupilRef}
              className="w-[4px] h-[4px] bg-[#0f172a] rounded-full transition-transform duration-150 ease-in-out origin-center"
            />
          </div>
        </div>
        ...
        */}
        <div 
          ref={rightAnchorRef}
          className="absolute pointer-events-none" 
          style={{ top: '25.4%', left: '59.9%', width: '0px', height: '0px' }}
        >
          <div 
