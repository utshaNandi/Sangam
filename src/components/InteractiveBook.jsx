              ...
              >
                ...
                >
                  <input 
                    ...
                    required={isSignUp}
                    disabled={!isSignUp}
                    className="w-full bg-white/20 backdrop-blur-md text-white placeholder:text-white/70 text-[11px] px-3.5 py-2 rounded-md outline-none hover:bg-white/25 focus:bg-white/30 border border-white/10 focus:border-white/60 focus:ring-2 focus:ring-white/20 transition-all duration-300 shadow-inner focus:shadow-md" 
                  />
                </div>
