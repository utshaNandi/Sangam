...
// The end of StudentsView is currently:
...
// }
// And the end of AttendanceView is:
...
const fullRestore = `  return <TreeHierarchy title="Students" tree={tree} branches={branches} renderContent={renderContent} expandedNodes={expandedNodes} toggleNode={toggleNode} />;
}
...
content = content.replace(regex, fullRestore);
